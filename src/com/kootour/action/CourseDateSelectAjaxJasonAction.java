...
public class CourseDateSelectAjaxJasonAction extends BaseAction {
	...
	@Action(value = "courseDateSelect")
	public String courseDateSelect() {
		String rtnStr = "json";
		Map<String, Object> jsonMap = new HashMap<String, Object>();
		Gson gson = new Gson();

		try {
			CourseDateSelectAjaxEntity inModel = gson.fromJson(jsonFromWeb, CourseDateSelectAjaxEntity.class);
