				...
				<div class="main-content-inner">
					...
					<div class="widget-header">
						<div class="widget-title bigger lighter">
							...
							<a href="#"><Strong style="color:white">Localhost List&nbsp;|&nbsp;</Strong></a>
							...
							<div class="widget-box kootour-widget-color-main light-border">
								<div class="widget-header">
									<h4 class="widget-title lighter">
										<span class="white">Localhost List</span>
									</h4>
								</div>
								<div class="widget-body kootour-widget-color-main">
									...
									<div class="table-responsive">
										...
										<tbody>
										<s:iterator var="kooLocalhostInfoGroup" value="#request.kooLocalhostInfoList" status="status">
											<tr class="">
												<td>
													<s:property value="#kooLocalhostInfoGroup.localhostName" />
												</td>
												<td>
													<s:property value="#kooLocalhostInfoGroup.location" />
												</td>
												<td>
													<s:property value="#kooLocalhostInfoGroup.signupDate" />
												</td>
												<td>
													<s:property value="#kooLocalhostInfoGroup.courseNum" />
												</td>
												<td>
													<s:property value="#kooLocalhostInfoGroup.mailVerification" />
												</td>
												<td>	
													<s:property value="#kooLocalhostInfoGroup.telVerification" />
												</td>
												<td>
													<s:property value="#kooLocalhostInfoGroup.totalSale" />
												</td>
												<td>
													<s:property value="#kooLocalhostInfoGroup.score" />
												</td>
												<td>
													<s:property value="#kooLocalhostInfoGroup.rank" />
												</td>
											</tr>
										</s:iterator>
										</tbody>
