            ...
            <div class="col-lg-offset-3 col-md-offset-2 col-lg-6 col-md-8 col-sm-12 col-xs-12">
                <section class="section">
                    <!-- <div class="login-wrap">
                        ...
                        <div class="login-container">
                            <p class="nomargin text-left blue"><a href="signup.html">Sign Up</a></p>
                        </div>
                    </div>
                    ...
                    <form id="form1" action = "kootourLogin!login" onSubmit="return false;" class="login-form">
                        <div class="form-group">
                        ...
                        <button type="submit" onclick="loginBtnClick();" class="btn btn-kootour-bold fullwidth">Kootour Login</button>
