				...
				<div class="main-content-inner">
					...
					<div class="widget-header">
						<div class="widget-title bigger lighter">
							...
							<a href="#"><Strong style="color:white">Tourist List&nbsp;|&nbsp;</Strong></a>
							...
							<div class="widget-box kootour-widget-color-main light-border">
								<div class="widget-header">
									<h4 class="widget-title lighter">
										<span class="white">Tourist List</span>
									</h4>
								</div>
								<div class="widget-body kootour-widget-color-main">
									...
									<div class="table-responsive">
										...
										<tbody>
										<s:iterator var="kooTouristInfoGroup" value="#request.kooTouristInfoList" status="status">
											<tr class="">
												<td>
													<s:property value="#kooTouristInfoGroup.touristName" />
												</td>
												<td>
													<s:property value="#kooTouristInfoGroup.location" />
												</td>
												<td>
													<s:property value="#kooTouristInfoGroup.gender" />
												</td>
												<td>
													<s:property value="#kooTouristInfoGroup.birthDay" />
												</td>
												<td>
													<s:property value="#kooTouristInfoGroup.signupDate" />
												</td>
												<td>
													<s:property value="#kooTouristInfoGroup.mailVerification" />
												</td>
												<td>
													<s:property value="#kooTouristInfoGroup.telVerification" />
												</td>
												<td>
													<s:property value="#kooTouristInfoGroup.totalOrder" />
												</td>
											</tr>
	                                    </s:iterator>    
										</tbody>
